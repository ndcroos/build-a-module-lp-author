function Invoke-Gh
{
    ...
    # Executes the Invoke-WebRequest cmdlet with the parameters specified in the variable @params
    $response = Invoke-WebRequest @params

    # checks whether the $ReturnRaw switch parameter is present 
    # (i.e., whether it was specified when calling the script or function
